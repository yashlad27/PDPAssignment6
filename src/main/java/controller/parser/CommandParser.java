...
/**
 * A robust command parser that handles the parsing and interpretation of user commands in the
 * calendar application. This parser supports multiple command formats including calendar
 * management, event creation/modification, and various utility operations. The parser uses regular
 * expressions to match command patterns and delegates the command execution to appropriate command
 * handlers through a command factory.
 *
...
public class CommandParser {
  ...
  /**
   * Constructs a new CommandParser with the specified command factory. Initializes the command
   * patterns and prepares the parser for use.
   *
  ...
  /**
   * Initializes the default command patterns supported by the parser. This method sets up regular
   * expressions for matching various command formats and associates them with their respective
   * parsing functions.
   *
  ...
  /**
   * Registers a new command pattern with the parser. This method allows extending the parser's
   * capabilities by adding new command formats.
   *
  ...
  /**
   * Parses a command string into an executable command with its arguments. This method validates
   * the command format and delegates to appropriate pattern parsers.
   *
  ...
  /**
   * Removes surrounding quotes (single or double) from a string value. This helper method ensures
   * consistent handling of quoted parameters in commands.
   *
  ...
  /**
   * Represents a command along with its arguments, providing a way to execute the command. This
   * class encapsulates the relationship between a command and its parameters.
   */
  ...
  /**
   * Encapsulates a command pattern with its matching regex and parsing function. This class helps
   * organize the relationship between command formats and their parsers.
   */
